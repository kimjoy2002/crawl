...
const vector<god_power> god_powers[NUM_GODS] =
{
 ...
 //          "Elyvilon is no longer ready to bless your weapon." },
    ...
    { { 2, ABIL_BEOGH_SMITING, "smite your foes" },
      ...
      { 4, ABIL_BEOGH_RETURN_ORCISH_FOLLOWERS, "return your orcish followers" },
      { 5, "walk on water" },
    ...
    { { 1, ABIL_JIYVA_CALL_JELLY, "request a jelly" },
      ...
      { 4, ABIL_JIYVA_CORROSION_DUNGEON, "corrosion the dungeon" },
...
>>>>>>> 2449d757c244ab63357914d87adb2476bb39d865
        
        change_draconian_colour();
        give_level_mutations(you.species, 7); //for draconian
        if (you.experience_level >= 14) {
            give_level_mutations(you.species, 14); //for yellow draconian
        }
    }
